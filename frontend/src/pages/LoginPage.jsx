                    ...
                    <form onSubmit={submitHandler} className="space-y-4">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5 ml-1 px-1">
                                <label className="block text-sm font-semibold text-gray-700 dark:text-dark-text-main">Password</label>
                                <a href="#" className="text-xs font-semibold text-indigo-600 dark:text-dark-accent hover:text-indigo-500 dark:hover:text-indigo-400">
                                    Forgot Password?
                                </a>
                            </div>
                            <div className="relative">
